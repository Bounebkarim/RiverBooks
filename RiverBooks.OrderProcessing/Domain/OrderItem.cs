...
internal class OrderItem(Guid bookId, int quantity, decimal unitPrice, string description)
{
  ...
  public string Description { get; set; } = Guard.Against.NullOrWhiteSpace(description);
}
